...
<ul class="rechb">
    <li>
        <span> 兑换数量 </span>  <input id="rechargeNum" type="text" placeholder="请输入兑换美购券的红积分数量" />
    </li>
    <li class="rechb-li">
...
<script type="text/javascript">
    ...
    $('#rechargeNum').change(function(){
        ...
        $.getJSON('/index.php?r=m/point/exchange-red-balance-num', {rechargeNum : rechargeNum}, function(data){
            if(data.code == 1){
    ...
    $('a.recha-a').click(function(){
        ...
        $.post('/index.php?r=m/point/exchange-red-balance', postData, function(data){
            if(data.code === 1){
                alert(data.msg);
